...
import { createOrder, getAllOrders, getDistinctUsersByFurniture } from '../controllers/orderController.js';
...
router.route('/orders/users').get(getDistinctUsersByFurniture).all(methodNotAllowed);
